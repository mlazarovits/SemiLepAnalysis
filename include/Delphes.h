...
// Thu Sep 19 10:59:18 2019 by ROOT version 6.18/02
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3771;
   static constexpr Int_t kMaxTrack = 209;
   static constexpr Int_t kMaxTower = 348;
   static constexpr Int_t kMaxEFlowTrack = 209;
   static constexpr Int_t kMaxEFlowPhoton = 153;
...
// #ifdef Delphes_cxx
inline Delphes::Delphes(TTree *tree) : fChain(0) 
{
...
inline Delphes::~Delphes()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

inline Int_t Delphes::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
inline Long64_t Delphes::LoadTree(Long64_t entry)
{
...
inline void Delphes::Init(TTree *tree)
{
   ...
   // fChain->SetBranchStatus("Jet_Flavor",1);
   // fChain->SetBranchStatus("Jet_BTag",1);
   // // fChain->SetBranchStatus("Jet_Eta",1);
   // // fChain->SetBranchStatus("Jet_Eta",1);
   // // fChain->SetBranchStatus("Jet_Eta",1);
   // // fChain->SetBranchStatus("Jet_Eta",1);
